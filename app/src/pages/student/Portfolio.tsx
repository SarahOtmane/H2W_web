                ...
                <ButtonBlack text="Créer mon portfolio" 
                    icon={
                        <svg width="30" height="31" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M14.334 8.83325H13.0007C9.66732 8.83325 8.33398 10.1666 8.33398 13.4999V17.4999C8.33398 20.8333 9.66732 22.1666 13.0007 22.1666H17.0007C20.334 22.1666 21.6673 20.8333 21.6673 17.4999V16.1666" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                            <path d="M17.6933 9.51326L12.4399 14.7666C12.2399 14.9666 12.0399 15.3599 11.9999 15.6466L11.7133 17.6533C11.6066 18.3799 12.1199 18.8866 12.8466 18.7866L14.8533 18.4999C15.1333 18.4599 15.5266 18.2599 15.7333 18.0599L20.9866 12.8066C21.8933 11.8999 22.3199 10.8466 20.9866 9.51326C19.6533 8.17992 18.5999 8.60659 17.6933 9.51326Z" stroke="white" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                    ...
                    } handleClick={() => setCreatePortfolio(true)} />
                </div>
            )}
