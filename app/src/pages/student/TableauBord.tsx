...
import back from '../../assets/images/student/tbord_newsletter_back.png';
    ...
    return(
        <main className="px-4 md:px-38 md:pt-10 md:pb-20 bg-gray-background">
            ...
            <section className="flex flex-col md:flex-row justify-between mt-18">
                <div className="w-1/2 ml-0 md:ml-[.5rem] bg-custom-black text-white rounded-[1rem] pl-12 py-10"
                    style={{ backgroundImage: `url(${back})`, backgroundRepeat: 'no-repeat',backgroundPosition: 'right top',}}>
