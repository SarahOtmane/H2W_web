...
const LandingPage = () => {
    ...
    return (
        <>
            ...
            <main className=" bg-gray-background w-full px-4 md:px-38 md:pt-50 md:pb-20 relative">
                <SectionAlternance />
                <a href="#services" className='top-[75%] right-[6.5%] fixed z-9998'>
                ...
                <FAQ />
                <div className="bg-lilas rounded-[2rem] mt-20 flex justify-between px-20" id="newsletter">
                    <div className="w-[60%] mt-20">
                        ...
                        <div className="flex flex-row items-center mt-8">
                            <input type="email" placeholder="Votre adresse e-mail" className="w-[70%] px-4 font-Jakarta-regular italic text-sm sm:text-base md:text-lg lg:text-body  py-4 pl-4 rounded-[2rem] border-1 text-input-text bg-gray-background border-gray-background focus:outline-lilas"/>
                            <ButtonBlack style="ml-4" text="Je m'abonne" icon={<Icon name="flecheButton" />} />
                        </div>
                    </div>
