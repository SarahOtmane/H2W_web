...
const Newsletter: React.FC = () => {
    ...
    return ( 
        <form className="w-full px-20">
            ...
            />
            <div className="w-full bg-white px-8 py-6 rounded-[4rem] border border-gray-border font-Jakarta-medium flex flex-col sm:flex-row items-center sm:justify-between space-y-3 sm:space-y-0 sm:space-x-6 mb-10 shadow-md">
                <input 
                    type="text"
