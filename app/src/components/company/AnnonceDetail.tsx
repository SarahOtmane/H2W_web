                    ...
                    <article className="flex mt-3">
                        ...
                        <p className="flex px-4 py-2 bg-gray-background rounded-[.6rem] ">
                            <svg width="23" height="24" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M12.495 17.0513H10.5961C9.80801 17.0513 9.17188 17.6874 9.17188 18.4755V21.7986H13.9192V18.4755C13.9192 17.6874 13.283 17.0513 12.495 17.0513Z" stroke="#6F6F6F" strokeWidth="1.42419" strokeMiterlimit="10" strokeLinejoin="round"/>
                                <path d="M9.16869 13.9657H7.26977C6.74757 13.9657 6.32031 13.5384 6.32031 13.0162V11.592C6.32031 11.0698 6.74757 10.6426 7.26977 10.6426H9.16869C9.69089 10.6426 10.1182 11.0698 10.1182 11.592V13.0162C10.1182 13.5384 9.69089 13.9657 9.16869 13.9657Z" stroke="#6F6F6F" strokeWidth="1.42419" strokeMiterlimit="10" strokeLinejoin="round"/>
