            ...
            {portfolio.experiences.length>0  && (
                <div >
                    ...
                    {experiences.map((experience, index) => (
                        <div key={index} className="border-lilas bg-input-file border-1 rounded-[1rem] mt-6 px-12 py-8">
                                        ...
                                        <>
                                            ...
                                            {missionHiden && 
                                                ...
                                                >
                                                    ...
                                                    <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M15.7705 7.08496L10.6088 12.2466C9.99922 12.8562 9.00172 12.8562 8.39214 12.2466L3.23047 7.08496" stroke="#1D1D1B" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                                                    </svg>
                                                </button>
                                            }
                                            ...
                                            {!missionHiden && 
                                                ...
                                                >
                                                    ...
                                                    <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M3.23047 11.915L8.39214 6.75342C9.00172 6.14384 9.99922 6.14384 10.6088 6.75342L15.7705 11.915" stroke="#1D1D1B" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                                                    </svg>
                                                </button>
                                            }
                                        </>
