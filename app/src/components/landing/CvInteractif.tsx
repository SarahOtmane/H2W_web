...
const CvInteractif = () => {
    return (
        <section className="mt-34">
            <h2 className="font-Jakarta-extra-bold text-[48px] w-[55%] m-auto text-center"><span className="bg-gradient-to-r from-custom-orange to-lilas text-transparent bg-clip-text">Démarquez-vous</span> avec votre CV interactif unique</h2>
            <p className="font-Jakarta-semi-bold text-[20px] text-gray-text w-[50%] m-auto text-center mt-6">Oubliez les CV classiques ! Valorisez vos compétences avec un portfolio dynamique et captivant. 
                Faites la différence en un instant.
            </p>
            <div className="w-[90%] m-auto mt-20 relative">
                <div className='w-[.4rem] h-[78rem] bg-gradient-to-b from-lilas to-custom-orange absolute left-[49.7%] rounded-[.5rem]'></div>
                <div className="flex flex-row items-center">
                    <div className='w-1/2'><img src={etape1} /></div>
                    <div className='h-[1rem] w-[1rem] bg-white rounded-[50%] hidden md:block z-99'></div>
                    <article className='w-1/2 px-[3.5rem]'>
                ...
                <div className="flex flex-row items-center">
                    <article className='w-1/2 pr-[9rem]'>
                    ...
                    <div className='h-[1rem] w-[1rem] bg-white rounded-[50%] hidden md:block z-99'></div>
                    <div className='w-1/2 flex justify-end'><img src={etape2} /></div>
                </div>
                <div className="flex flex-row items-center">
                    <div className='w-1/2'><img src={etape3} /></div>
                    <div className='h-[1rem] w-[1rem] bg-white rounded-[50%] hidden md:block z-99'></div>
                    <article className='w-1/2 px-[3.5rem]'>
                ...
                <div className="flex flex-row items-center">
                    ...
                    <div className='h-[1rem] w-[1rem] bg-white rounded-[50%] hidden md:block z-99'></div>
                    <div className='w-1/2 flex justify-end'><img src={etape4} /></div>
                </div>
            </div>
        </section>
    );
