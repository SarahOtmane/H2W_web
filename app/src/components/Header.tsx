    ...
    return (
        <header className='flex flex-row justify-between items-center bg-white md:bg-gray-background px-4 py-4 md:px-16 md:py-3 lg:px-38 lg:py-8'>
            ...
            <ul className='md:flex md:flex-row font-Jakarta-semi-bold hidden'>
                <li className='mr-8 md:text-[.7rem]'><Link to='#'>Nos services</Link></li>
                <li className='mr-8 md:text-[.7rem]'><Link to='#'>Étudiant</Link></li>
                <li className='mr-8 md:text-[.7rem]'><Link to='#'>Entreprise</Link></li>
                <li className='mr-8 md:text-[.7rem]'><Link to='#'>École</Link></li>
                <li className='mr-8 md:text-[.7rem]'><Link to='#'>À propos</Link></li>
            </ul>
            {isMobile && (
                <>
